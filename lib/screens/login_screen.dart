      ...
      child: Center(
        child: Container(height: 400,width: 300,color: Colors.black.withOpacity(.6),
          child: Column(mainAxisAlignment: MainAxisAlignment.center,
            children: [
              const CustomText(text: 'Login', size: 25),
              const SizedBox(height: 30,),
              CustomTextField(text: 'Username', con: userEditingController, choice: false, no: 20),
              ...
              const SizedBox(height: 30,),
                ...
                },style: ElevatedButton.styleFrom(backgroundColor: Colors.white.withOpacity(.7)), child: const Text('Login'),),
              const Row(mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("Don't you have an account?",style: TextStyle(color: Colors.grey,fontSize: 10),),
                  CustomText(text:'Sign up' , size: 11),
                ],
              )
            ],
          ),
