...
class TopRatedMovies extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    context.read<CategoriesProvider>().getTopRated(context);
    return Scaffold(
              ...
              child: Column(
                children: [
                  Stack(children: [
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return CustomScrollContainer(
                            ...
                            image: value.movies![index].posterPath!=null?ApiConstants.imageUrl +
                                value.movies![index].posterPath!:ApiConstants.defaultImage,
                          );
                        },
                        separatorBuilder:
                    ...
                    Positioned(
                        top: Dimensions.customHeight(context, 8.68235),
                        child: Row(
                  ...
                  CustomGridview(similarList: value.movies??[],)
                ],
              ),
            );
          },)
